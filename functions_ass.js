...
function addNewBook(object){
 books: 
        { title: 'blossoms of the savanna', author; 'Parsimei', publicationYear; 2019,
    isAvailable; true }
    
  let b=getAvailableBooks.addNewBook[books]
